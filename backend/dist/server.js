...
const supabaseClient_1 = __importDefault(require("./supabaseClient")); // Import supabase client
...
app.get('/api/users', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { data, error } = yield supabaseClient_1.default.from('users').select('id');
...
app.get('/supabase/status', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { error } = yield supabaseClient_1.default.from('users').select('id').limit(1);
        if (error) {
